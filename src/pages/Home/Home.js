...
<Flex flexDirection="row">
      ...
      <Text w="457px" lineHeight="45px" fontSize="30px" h="135px" left="1020px" fontWeight="600" color="rgba(3, 6, 74, 0.4);" pos="absolute" top="419px">with verificate you can test your skills and earn certificate in form of an NFT</Text>
      <Button
          _hover={{
            bg: "#03064A",
