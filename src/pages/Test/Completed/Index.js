  ...
  return (
    <Box  m="0 auto" w={{base:"90%", md:"90%", lg:"85%"}}>
        <Text fontSize="2xl" fontWeight="700" textAlign="center"  >Completed Test</Text>
          <Flex  justifyContent="space-between" mt="120px" mx=" auto">
            <Flex  w={{base:"90%", md:"250px", lg:"280px"}} borderRadius="14px" boxShadow="6px 4px 27px rgba(3, 6, 74, 0.25)" py="20px" flexDirection="column" justifyContent="center">
                <Flex color="#03064A" fontWeight="650" fontSize="24px" m="0 auto" align="center">
